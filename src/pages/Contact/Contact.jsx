...
function Contact() {
  ...
  const contactCards = [
    {
      ...
      title: 'Email Us',
      details: ['se.abdelrahman968@gmail.com', 'We reply within 24 hours'],
    },
    {
      icon: <FaPhone className="text-2xl text-purple-500" />,
      title: 'Call Us',
      details: ['+20 155 679 0812', 'Mon – Fri, 9am – 6pm EST'],
    },
    {
      icon: <FaMapMarkerAlt className="text-2xl text-pink-500" />,
      title: 'Visit Us',
      details: ['Egypt', 'El mansoura, CA 35521'],
    },
  ];
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Contact Us - Get in Touch with Nexora"
        path="/contact"
      />
